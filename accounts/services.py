...
TRACKER_STORY_GENERATION_COST = 10
TRACKER_STORY_BACKGROUND_COST = 5
MONTHLY_SUMMARY_GENERATION_COST = 60
MONTHLY_SUMMARY_BACKGROUND_COST = 5
READING_CALENDAR_GENERATION_COST = 50
READING_CALENDAR_BACKGROUND_COST = 5
MONTHLY_CHALLENGE_GOAL_EDIT_COST = 50
REVIEW_IMAGE_GENERATION_COST = 50
REVIEW_IMAGE_BACKGROUND_COST = 5
CURRENT_READING_IMAGE_GENERATION_COST = 20
CURRENT_READING_IMAGE_BACKGROUND_COST = 5
ANNUAL_GAME_REPORT_GENERATION_COST = 20
RANDOM_BOOK_SELECTION_COST = 10
