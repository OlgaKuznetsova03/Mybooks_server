...
urlpatterns = [
    ...
    path("me/shelves/want/", views.want_shelf_page, name="want_shelf_page"),
    path("me/shelves/read/", views.read_shelf_page, name="read_shelf_page"),
    ...
    path("reading/unfinished/<int:progress_id>/", views.reading_mark_unfinished, name="reading_mark_unfinished"),
    path(
